# Deutsch Service - production image for on-premises (Ubuntu + docker-compose) and Azure Web App for Containers.
#
# Build:  docker build -t <dockerhub-user>/languageapp-deutsch:latest .
# Run:    provide DEUTSCH_DATABASE_URL, DEUTSCH_DATABASE_MIGRATION_URL, SECRET_TOKEN_KEY, AUTH_ALGORITHM,
