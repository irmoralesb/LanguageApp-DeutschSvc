...
class Settings(BaseSettings):
    ...
    def read_azure_connection_strings(cls, data: Any) -> Any:
        ...
        for field_name, alias, env_bases in (
            ("database_url", "DEUTSCH_DATABASE_URL", ("DEUTSCH_DATABASE_URL", "DeutschDatabaseUrl")),
            (
                "database_migration_url",
                "DEUTSCH_DATABASE_MIGRATION_URL",
                ("DEUTSCH_DATABASE_MIGRATION_URL", "DeutschDatabaseMigrationUrl"),
            ),
        ):
